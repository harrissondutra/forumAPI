...
public class TopicosController {
    ...
    @GetMapping //Filtra curso por nome, ou trás todos (ALL).
    ...
    @PutMapping("/{id}")
    @Transactional
    public ResponseEntity<TopicoDto> alteraTopico(@PathVariable Long id, @RequestBody @Valid AtualizacaoTopicoForm form){
